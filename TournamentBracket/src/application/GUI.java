...
public class GUI {
     ...
     * the winner if there's more than 1 team, call setupCenterRegular() method
     * 
     * @return HBox
     */
    ...
    private static Button setupLoadButton() {
        ...
        loadButton.setOnMouseEntered(e -> {loadButton.setStyle("-fx-text-fill: #f7f7f7;");});
        loadButton.setOnMouseExited(e -> {loadButton.setStyle("-fx-text-fill: #c5050c;");});
        return loadButton;
    }
}
