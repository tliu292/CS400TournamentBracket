...
public class Game {
	...
	public void setGameBoard(Node node) {
		this.gameBoard = (VBox) node;
	}
	     ...
	     submit.setOnAction(new EventHandler<ActionEvent>()
	         {
	           public void handle(ActionEvent arg0) {
	                ...
	                if (score > 0) {
	                	Game changeGame = Main.games.get((gameNumber-1)/2+Main.teams.size()/2);
	                  	changeGame.addTeam1(team1);
	                }
	           }         
	       }
	    );
	...
	public VBox addTeam1(Team team1) {
		this.team1 = team1;
		((Label)((HBox)gameBoard.getChildren().get(0)).getChildren().get(0)).setText(team1.getRank() + "  " + team1.getName());
		return setUpGame();
	}
